...
public class Pesquisa_Cliente_View extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        if (tbl_lista.getColumnModel().getColumnCount() > 0) {
            tbl_lista.getColumnModel().getColumn(0).setPreferredWidth(3);
            tbl_lista.getColumnModel().getColumn(1).setPreferredWidth(100);
            tbl_lista.getColumnModel().getColumn(2).setPreferredWidth(20);
        }

        txt_campo.setText("Campo a ser Pesquisado");

        cb_apesquisar.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Codigo", "Nome", "Sexo" }));
